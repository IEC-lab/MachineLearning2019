#150 observations of iris flowers from three different species.
#dimension of input feature is 4:sepal length, sepal width, petal length and petal width
#target class is three species:setosa, versicolor or virginica
#we can split the data into training and test datasets and use the results to evaluate our algorithm implementation.
import csv
import random
import math
import operator
...
#At the end of the run, you will see the accuracy a little over 94%.